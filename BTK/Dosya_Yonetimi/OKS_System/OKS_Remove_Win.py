...
class Ui_Form_Remove():
    def setupUi(self,Form):
        ...
        self.qLabel_isim_remove.setText("Name")
        self.qLabel_isim_remove.setFont(QtGui.QFont("Sanserif", 10))
        self.lineEdit_isim_remove = QLineEdit(Form)

        self.qLabel_soyisim_remove = QLabel()
        self.qLabel_soyisim_remove.setText("Surname")
        self.qLabel_soyisim_remove.setFont(QtGui.QFont("Sanserif", 10))
        ...
        self.qPushbutton_remove.setText("Remove")

        self.qPushbutton_find_remove = QPushButton()
        self.qPushbutton_find_remove.setGeometry(QtCore.QRect(150, 172, 111, 51))
        self.qPushbutton_find_remove.setText("Find")

        self.qLabel_aciklama_remove = QLabel()
        self.qLabel_aciklama_remove.setText("Explanation")
        self.qLabel_aciklama_remove.setFont(QtGui.QFont("Sanserif", 10))

#===============================================================================
        qhbox = QHBoxLayout()
        qhbox.addWidget(self.qLabel_isim_remove)
        qhbox.addWidget(self.lineEdit_isim_remove)
        qhbox.addWidget(self.qLabel_soyisim_remove)
        ...
        qvbox.addWidget(self.qPushbutton_find_remove)
        qvbox.addWidget(self.qLabel_aciklama_remove)
        qvbox.addStretch()
