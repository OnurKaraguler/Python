import sys
sys.path.append('C:/Python_Examples/BTK/BTK_QT/Dosya_Yonetimi/OKS_System/OKS_Func')
...
# from OKS_findPerson import OKS_findPerson
from OKS_findPersonFunc import OKS_findPerson
...
class Ui_Form():
    def __init__(self):
        ...
        self.remove_window_object = OKS_findPerson()
        # self.remove_window_object = OKS_findPerson()

    def open_remove_window(self):
        self.remove_window_object.show()
    ...
    def setupUi(self, Form):
        ...
        self.Pushbutton_hesapla = QPushButton()
        self.Pushbutton_hesapla.setGeometry(QtCore.QRect(150, 172, 111, 51))
        self.Pushbutton_hesapla.setText("Hesapla")

        self.qPushbutton_removeWindow = QPushButton()
        self.qPushbutton_removeWindow.setGeometry(QtCore.QRect(150, 172, 111, 51))
        self.qPushbutton_removeWindow.setText("Remove")
...
#===============================================================================
        ...
        grid.addWidget(self.Pushbutton_hesapla, 2, 4)
...
# ===============================================================================
        self.qPushbutton_removeWindow.clicked.connect(self.open_remove_window)
